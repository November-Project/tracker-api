...
#     echo '{ "name": "novproject", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/novproject/novproject
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/novproject/novproject production -p $PORT
